...
The Exchange will provide Abra with a **Private Key** and an **API Key**.
...
Json Payload are concatenated and the Private Key is used as the secret key to create the HMAC.  The
